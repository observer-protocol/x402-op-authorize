...
| 231/231 parity harness, 5 engines, shared core | GREEN |
...
| Cross-rail demo (one $5 budget: USDC-on-Base + Lightning, both rails deny over-budget) | GREEN — `demo/TRANSCRIPT.txt` |
